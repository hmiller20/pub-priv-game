...
export default function PregamePage() {
  ...
  useEffect(() => {
    if (showModal && !isTimerActive && modalPage === 2) {
    ...
    1: {
      ...
      content: (
        <CardContent className="space-y-4">
          <p>
            In this task, you will be presented with three words. Your goal is to find a fourth word that is associated with all three words shown.
          </p>
          <p>
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-24 bg-blue-100">
      <h1 className="mb-8 text-3xl font-bold">Remote Associates Test 🧠</h1>
