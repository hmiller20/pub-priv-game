...
export default function Importance() {
  ...
  const importanceSteps = [
    ...
    },
    {
      content: (
        <div className="text-left">
          After you complete the task, you will chat with your group again. You will discuss <span className="font-bold underline">the role of creativity in living a good life.</span>
        </div>
      ),
      type: "text"
    }
      ...
      <div className="space-y-4">
        <div className="transition-opacity duration-300">
          <p className="text-center text-lg">
            {typeof importanceSteps[currentStep].content === "string" 
              ? importanceSteps[currentStep].content 
              : importanceSteps[currentStep].content}
          </p>
        </div>
