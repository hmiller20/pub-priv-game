...
export default function PublicPostgamePage() {
  ...
  // Handle posting score to leaderboard
  const postScore = () => {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center p-4 md:p-24 bg-blue-100">
      <h1 className="mb-8 text-3xl font-bold">Anagram Glam 👀</h1>
        ...
        <CardContent className="space-y-4">
          <div className="flex flex-col items-center space-y-4 py-8">
            ...
            <p className="text-center text-muted-foreground mt-4">
              You can play again to try to improve your score, or you can post your current score to the leaderboard.
            </p>
            {scorePosted && (
